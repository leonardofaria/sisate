...
/*
##$obj = new Protocolo("1562786137");
#echo $obj->formataProtocolo();
#die;
#'35918002624201255'
$obj = new Protocolo("35918002624201255");
echo $obj->validaProtocolo();

echo "<br/>";
#'23001060100722117'
$obj = new Protocolo('23001060100722117');
echo $obj->validaProtocolo();

echo "<br/>";
#'421562786137'
$obj = new Protocolo('421562786137');
echo $obj->validaProtocolo();
echo "<br/>";
#'421562786137'
$obj = new Protocolo('1562786137');
